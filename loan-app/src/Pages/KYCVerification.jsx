          ...
          <div className="card-body">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-3">
                ...
                />
                {errors.panId && <p className="text-danger">PAN ID is required</p>}
              </div>
              <div className="mb-3">
                ...
                />
                {errors.aadharId && <p className="text-danger">Aadhaar ID is required</p>}
              </div>
              ...
              {showOtp && (
                <div className="mb-3">
                  ...
                  {errors.otp && <p className="text-danger">All OTP fields are required</p>}
                </div>
              )}
              <button
                type="submit"
