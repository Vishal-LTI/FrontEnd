            ...
            <div className="card-body">
              <form onSubmit={handleSubmit(onSubmit)} className="row g-3">
                <div className="col-md-4">
                  ...
                  />
                  {errors.loanAmount && (
                    <p className="text-danger">Loan Amount is required</p>
                  )}
                </div>
                <div className="col-md-4">
                  ...
                  />
                  {errors.tenureInYears && (
                    <p className="text-danger">Tenure in Years is required</p>
                  )}
                </div>
                <div className="col-md-4">
                  ...
                  {errors.tenureInMonths && (
                    <p className="text-danger">Tenure in Months is required</p>
                  )}
                </div>
                <div className="col-md-4">
                  ...
                  />
                  {errors.emiDebitedDate && (
                    <p className="text-danger">EMI Debited Date is required</p>
                  )}
                </div>
                <div className="col-md-4">
                  ...
                  />
                  {errors.interest && (
                    <p className="text-danger">Interest Rate is required</p>
                  )}
                </div>
                <div className="col-md-4">
                ...
                <div className="col-md-4">
                  ...
                  />
                  {errors.loanStatus && (
                    <p className="text-danger">Loan Status is required</p>
                  )}
                </div>
